...
module.exports = function () {
    return function (irc) {
        irc.define('irc', 'join', function ircJoin(channels, keys, network, fn) {
            ...
            for(var i=0; i < channels.length; i++) {
                ...
                this.write('WHO ' + parse.target + ' %na', network ? network : parse.network);
            }
        });

        irc.define('irc', 'cycle', function ircCycle(channels, msg, keys, network, fn) {
          if (!msg) msg = "cycling";
