...
module.exports = function () {
    return function (irc) {
        irc.define('irc', 'capLs', function capLs(network, fn) {
            irc.write("CAP LS", network, fn);
        });

        irc.define('irc', 'capList', function capList(network, fn) {
            irc.write("CAP LIST", network, fn);
        });

        irc.define('irc', 'capReq', function capReq(capabilities, network, fn) {
        ...
        irc.define('irc', 'capClear', function capClear(network, fn) {
            irc.write("CAP CLEAR", network, fn);
            irc.capabilities = [];
        });

        irc.define('irc', 'capEnd', function capEnd(network, fn) {
