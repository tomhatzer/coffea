...
module.exports = function () {
    return function (irc) {
        ...
        irc.define('irc', 'pass', function ircPass(pass, network, fn) {
            this.write('PASS ' + pass, network, fn);
        });

        irc.define('irc', 'user', function ircUser(username, realname, network, fn) {
        ...
        irc.define('irc', 'oper', function ircOper(name, password, network, fn) {
