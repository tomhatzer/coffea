...
module.exports = function () {
    return function (irc) {
         ...
         * @api public
         */
        irc.define('irc', 'whois', function ircWhois(target, network, fn) {
        ...
        irc.on('data', function (err, msg) {
            ...
            case 'ERR_NOSUCHSERVER':
                ...
                if (cb) {
                    ...
                    utils.emit(irc, network, 'whois', new Error("No such server"));
                }
                break;
            case 'ERR_NOSUCHNICK':
                params = msg.params.split(' ');
                ...
                if (cb) {
                    ...
                    utils.emit(irc, network, 'whois', new Error("No such nick/channel"));
                }
                break;
            }
        });
