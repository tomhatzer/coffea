...
User.prototype.inspect = function (depth) {
    return "User {nick: " + this.nick + "}"; // TODO: extend?
};
...
module.exports = function () {
    ...
    return function (irc) {
        ...
        irc.define('irc', 'getUser', function (nick, network) {
            if (!nick) {
                if (!network) {
                    network = '0';
                }
