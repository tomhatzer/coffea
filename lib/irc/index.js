    ...
    return function (coffea) {
        ...
        function _connect(coffea, stream_id, info) {
            ...
            if (info.nickserv && info.nickserv.username && info.nickserv.password) {
                coffea.identify(info.nickserv.username, info.nickserv.password, stream_id);
            } else if (info.nickserv && info.nickserv.password) {
                coffea.identify(info.nickserv.password, stream_id);
            }
            if (info.channels) {
                coffea.join(info.channels, stream_id);
            }
        }
